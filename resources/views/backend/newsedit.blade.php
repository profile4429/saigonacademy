    ...
    <div class="container">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="text-center mb-0">Edit News</h5>
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('editNews')}}" enctype="multipart/form-data">
                    @csrf
                    <input name="id" type="hidden" class="form-control"
                        value="{{ $news->id }}">
                        <div class="form-group">
                            <label for="date"><b>Date:</b></label>
                            <input name="date" type="datetime-local" id="date" value="{{ $news->date }}" class="form-control" />
                        </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" id="image" name="image"
                            ...
                            <img class="card-img-top" style="height: 150px; width: 300px; object-fit: cover;" src="{{ asset('/images/' .$news->image) }}" alt="" id="preview-image">
                    </div>
                    <div class="form-group">
