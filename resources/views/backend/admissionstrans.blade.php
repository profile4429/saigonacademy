    ...
    <div class="container">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="text-center mb-0">Trans Admissions</h5>
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('transAdmissions')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input name="id" type="hidden" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <?php $language_id_from = $admissions->language_id ?? null; ?>
                        </div>
